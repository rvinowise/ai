...
module Mapping_functions_registry =
    ...
    let provide_function name mapping_function =
        Dictionary.some_value function_names_to_ids name
        |>function
        |Some mapping_function_id -> mapping_function_id
        |None ->
            remember_function name mapping_function
