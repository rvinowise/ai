    ...
    public void all_combinations_are_provided_in_a_loop() {
        ...
        List<SortedDictionary<string, string>> result_combinations = 
            new List<SortedDictionary<string, string>> {
                new SortedDictionary<string,string> {{"A1","a3"},{"A2","a2"},{"A3","a1"},},
                new SortedDictionary<string,string> {{"A1","a4"},{"A2","a2"},{"A3","a1"},},
                new SortedDictionary<string,string> {{"A1","a2"},{"A2","a3"},{"A3","a1"},},
                new SortedDictionary<string,string> {{"A1","a4"},{"A2","a3"},{"A3","a1"},},
                new SortedDictionary<string,string> {{"A1","a3"},{"A2","a1"},{"A3","a2"},},
                new SortedDictionary<string,string> {{"A1","a4"},{"A2","a1"},{"A3","a2"},},
                new SortedDictionary<string,string> {{"A1","a1"},{"A2","a3"},{"A3","a2"},},
            };
