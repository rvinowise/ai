...
public class Network_loader<TFigure>:
    MonoBehaviour
    where TFigure: class?, IFigure 
    
{
    public Network_persistence<TFigure> persistence;
    [SerializeField] private Figure_showcase figure_showcase;

    public static Network_loader<TFigure> instance;
    ...
    private void load_figure_appearances(IList<serializable.Figure_appearance> appearances) {
        Action_history history = persistence.action_history;
        Figure_provider<TFigure> figure_provider = persistence.figure_provider;
