...
public class Sequence_finder<TFigure>:
    ISequence_finder<TFigure>
    where TFigure: class?, IFigure
{
    ...
    private void find_new_sequences_starting_with(
        ...
        foreach (IFigure ending_figure in familiar_figures)
        {
            ...
            TFigure signal_pair = figure_provider.provide_sequence_for_pair(
                beginning_figure,
                ending_figure
            );
    ...
    private void delete_figure(TFigure figure) {
